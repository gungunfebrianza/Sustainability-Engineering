...
| Question                                                     | Question Type | Input Type             | Data Type        | Example Answer                                               |
| ------------------------------------------------------------ | ------------- | ---------------------- | ---------------- | ------------------------------------------------------------ |
| How many suppliers were assessed for social impacts during the reporting period? | Quantitative  | Number Input           | Integer          | 1,247                                                        |
| How many suppliers were identified as having significant actual negative social impacts? | Quantitative  | Number Input           | Integer          | 23                                                           |
| What percentage of assessed suppliers had significant negative social impacts? | Calculated    | Auto-calculated        | Percentage       | 1.8%                                                         |
| How many suppliers were identified as having significant potential negative social impacts? | Quantitative  | Number Input           | Integer          | 67                                                           |
| What percentage of assessed suppliers had significant potential negative social impacts? | Calculated    | Auto-calculated        | Percentage       | 5.4%                                                         |
| What types of actual negative social impacts were identified? | Qualitative   | Multi-select Checklist | Array            | ["Excessive working hours", "Unsafe working conditions", "Discrimination practices"] |
| What types of potential negative social impacts were identified? | Qualitative   | Multi-select Checklist | Array            | ["Child labor risk", "Forced labor risk", "Community displacement risk"] |
| How do you prioritize suppliers for social impact assessment? | Qualitative   | Text Area              | String           | "Risk-based approach considering country risk, spend level, and industry sector" |
| What assessment methodologies do you use?                    | Qualitative   | Multi-select Checklist | Array            | ["On-site audits", "Self-assessment questionnaires", "Third-party evaluations", "Worker interviews"] |
| How many on-site social audits were conducted during the reporting period? | Quantitative  | Number Input           | Integer          | 89                                                           |
| How many desktop assessments were conducted?                 | Quantitative  | Number Input           | Integer          | 1,158                                                        |
| Do you conduct unannounced audits?                           | Binary        | Yes/No                 | Boolean          | Yes                                                          |
| What percentage of audits were unannounced?                  | Quantitative  | Number Input           | Percentage       | 35                                                           |
| How many suppliers agreed to improvement plans following negative impact identification? | Quantitative  | Number Input           | Integer          | 21                                                           |
| What percentage of suppliers with negative impacts agreed to improvement plans? | Calculated    | Auto-calculated        | Percentage       | 91.3%                                                        |
| How many suppliers were terminated due to social impacts during the reporting period? | Quantitative  | Number Input           | Integer          | 2                                                            |
| What were the reasons for supplier termination?              | Qualitative   | Multi-select Checklist | Array            | ["Failure to remediate child labor", "Persistent safety violations"] |
| How many suppliers showed improvement in social performance? | Quantitative  | Number Input           | Integer          | 19                                                           |
| What is your typical timeframe for supplier remediation?     | Quantitative  | Number Input plus Unit | Integer + String | 90 days                                                      |
| Do you provide support to suppliers for improvement?         | Binary        | Yes/No                 | Boolean          | Yes                                                          |
| What types of support do you provide?                        | Qualitative   | Multi-select Checklist | Array            | ["Training programs", "Financial support", "Technical assistance", "Best practice sharing"] |
| How much did you invest in supplier social improvement programs? | Quantitative  | Currency Input         | Decimal          | 2,450,000                                                    |
| What currency is used for investment reporting?              | Qualitative   | Dropdown               | String           | "USD"                                                        |
| Do you collaborate with other buyers to address supplier social issues? | Binary        | Yes/No                 | Boolean          | Yes                                                          |
| Describe collaborative initiatives                           | Qualitative   | Text Area              | String           | "Member of Responsible Business Alliance, participate in joint audits with 5 other major buyers" |
| How do you monitor progress of supplier improvement plans?   | Qualitative   | Text Area              | String           | "Monthly progress reports, quarterly review meetings, follow-up audits within 6 months" |
| Do you have a grievance mechanism for supply chain workers?  | Binary        | Yes/No                 | Boolean          | Yes                                                          |
| How many grievances were received through supply chain channels? | Quantitative  | Number Input           | Integer          | 12                                                           |
...
| Question                                                     | Question Type | Input Type             | Data Type  | Example Answer                                               |
| ------------------------------------------------------------ | ------------- | ---------------------- | ---------- | ------------------------------------------------------------ |
| Do you maintain a social risk map of your supply chain?      | Binary        | Yes/No                 | Boolean    | Yes                                                          |
| How many countries are classified as high social risk in your supply chain? | Quantitative  | Number Input           | Integer    | 12                                                           |
| What criteria do you use to classify social risk?            | Qualitative   | Multi-select Checklist | Array      | ["Child labor prevalence", "Forced labor risk", "Freedom of association restrictions", "Gender discrimination"] |
| How often do you update your social risk assessments?        | Qualitative   | Dropdown               | String     | "Quarterly"                                                  |
| Do you use third-party risk intelligence services?           | Binary        | Yes/No                 | Boolean    | Yes                                                          |
| Which third-party services do you use?                       | Qualitative   | Text Area              | String     | "Verisk Maplecroft, RepRisk, Sustainalytics"                 |
| Do you assess social risks at the facility level?            | Binary        | Yes/No                 | Boolean    | Yes                                                          |
| How many supplier facilities were assessed for social risks? | Quantitative  | Number Input           | Integer    | 456                                                          |
| Do you require suppliers to conduct their own supplier assessments? | Binary        | Yes/No                 | Boolean    | Yes                                                          |
| What percentage of Tier 1 suppliers conduct downstream assessments? | Quantitative  | Percentage Input       | Percentage | 72                                                           |
| Do you assess social risks related to migrant workers in your supply chain? | Binary        | Yes/No                 | Boolean    | Yes                                                          |
| How many suppliers were identified as using migrant workers? | Quantitative  | Number Input           | Integer    | 67                                                           |
| Do you have specific protections for migrant workers in supplier contracts? | Binary        | Yes/No                 | Boolean    | Yes                                                          |
| Do you assess gender-related social risks in your supply chain? | Binary        | Yes/No                 | Boolean    | Yes                                                          |
| Do you assess risks to indigenous peoples in your supply chain? | Binary        | Yes/No                 | Boolean    | Yes                                                          |
| How many suppliers operate in areas with indigenous communities? | Quantitative  | Number Input           | Integer    | 23                                                           |
| Do you assess social risks related to land rights in your supply chain? | Binary        | Yes/No                 | Boolean    | Yes                                                          |
| Do you conduct social impact assessments for new sourcing regions? | Binary        | Yes/No                 | Boolean    | Yes                                                          |
| How many new sourcing regions were assessed for social impacts? | Quantitative  | Number Input           | Integer    | 3                                                            |

## Remediation and Improvement Questions

| Question                                                     | Question Type | Input Type             | Data Type        | Example Answer                                               |
| ------------------------------------------------------------ | ------------- | ---------------------- | ---------------- | ------------------------------------------------------------ |
| Do you have a formal supplier remediation process?           | Binary        | Yes/No                 | Boolean          | Yes                                                          |
| What is the maximum timeframe given to suppliers for remediation? | Quantitative  | Number Input plus Unit | Integer + String | 180 days                                                     |
| Do you offer financial support for supplier improvements?    | Binary        | Yes/No                 | Boolean          | Yes                                                          |
| What was the total amount invested in supplier social improvements? | Quantitative  | Currency Input         | Decimal          | 1,850,000                                                    |
| How many suppliers received financial support for social improvements? | Quantitative  | Number Input           | Integer          | 34                                                           |
| Do you provide technical assistance to suppliers?            | Binary        | Yes/No                 | Boolean          | Yes                                                          |
| What types of technical assistance do you provide?           | Qualitative   | Multi-select Checklist | Array            | ["Management system development", "Worker training programs", "Safety equipment installation"] |
| Do you facilitate peer-to-peer learning among suppliers?     | Binary        | Yes/No                 | Boolean          | Yes                                                          |
| How many supplier forums or workshops did you organize?      | Quantitative  | Number Input           | Integer          | 8                                                            |
...
| Do you collaborate with competitors on supplier social issues? | Binary        | Yes/No                 | Boolean   | Yes                                                          |
